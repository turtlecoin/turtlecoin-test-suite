...
function getSeedInfo () {
  return request({
    ...
    .then(info => { return { pass: true, info: info } })
    .catch(() => { return { pass: false, info: {} } })
}
...
function daemonTests () {
  ...
  console.log('')
  return question('What is the address of the daemon you would like to test? [127.0.0.1] ').then((daemonIp) => {
...
function serviceTests () {
  ...
  console.log('')
  return question('What is the address of turtle-service you would like to test? [127.0.0.1] ').then((serviceIp) => {
